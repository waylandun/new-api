...
func uniqueChannelAffinityStatsTestKey(t *testing.T) (string, string) {
	t.Helper()
	seq := channelAffinityStatsTestSeq.Add(1)
	return fmt.Sprintf("rule_%s_%d", t.Name(), seq), fmt.Sprintf("fp_%d", seq)
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName, keyFP := uniqueChannelAffinityStatsTestKey(t)
	usingGroup := "default"
